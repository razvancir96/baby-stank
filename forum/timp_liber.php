...
<body>
	...
	<div class="main-wrapper">
		...
		<h2>Topic: Timp liber</h2>
		<?php 
			require_once('../database/db_functions.php');
			$posts = get_free_time_posts();
		...
		<?php 
			if (isset($_SESSION['username'])) {
				...
				if (isset($_POST['send_message'])) {
					$new_post = add_post($_SESSION['username'], $_POST['forum_post'], 'timp_liber');
					// var_dump($new_post);
					header('Location:timp_liber.php');
				}
			} else {
				echo '<div class="main-register-link center">
